<template>
  ...
  <svg aria-hidden="true" focusable="false" :width="menuShow?28:24" :height="menuShow?28:16" >
  <use :href="menuOrcrose"></use>
  </svg>
  </button>
  
  <ul class="header__menu">
    <li class="header__menu-item"><a href="#" @click="switchMenu">Главная</a></li>
    <li class="header__menu-item"><a href="#testresults">Информация о тесте</a></li>
    <li class="header__menu-item"><button class="menuTextButton" type="button">Пройти тест</button></li>
  </ul>
